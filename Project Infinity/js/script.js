...
var swiper = new Swiper(".food-slider", { //buggy when item clicked but won't auto centered
  loop: true,
  centeredSlides: true,
...
function store(event) {
  ...
  if ((firstName == "") && (lastName == "") && (userName == "") &&
    ...
    alert("Message: Booking confirmed!\n You may check the booking details by toggling the check reservation button.");
  }
};
